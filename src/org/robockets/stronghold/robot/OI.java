...
public class OI {
	...
	public OI () {
		...
		ButtonManager.addButton(new ActionButton(1, 2, new MoveHood(-25, 0), true));
		ButtonManager.addButton(new ActionButton(1, 3, new MoveHood(25, 0), true));
		ButtonManager.addButton(new ActionButton(1, 4, new MoveTurnTable(-40, 0), true));
		ButtonManager.addButton(new ActionButton(1, 5, new MoveTurnTable(40, 0), true));
		ButtonManager.addButton(new ActionButton(1, 11, new MoveShootingWheel(1800), true));
		ButtonManager.addButton(new ActionButton(1, 10, new MoveShootingWheel(0), true));
		//ButtonManager.addButton(new ActionButton(1, 6, new HorizontalAlign(true), true));
		//ButtonManager.addButton(new ActionButton(1, 7, new RPMAlign(true), true));
		ButtonManager.addButton(new ActionButton(1, 8, new Track(), true));
		ButtonManager.addButton(new ActionButton(1, 9, new AutoFire(), true));
		
		ButtonManager.addButton(new ActionButton(2, 2, new SetVerticalIntake(Direction.DOWN, 0, IntakeSide.FRONT), true));
		ButtonManager.addButton(new ActionButton(2, 3, new SetVerticalIntake(Direction.UP, 0, IntakeSide.FRONT), true));
		ButtonManager.addButton(new ActionButton(2, 4, new SpinIntake(Direction.FORWARD, 0, IntakeSide.FRONT), true));
		ButtonManager.addButton(new ActionButton(2, 5, new SpinIntake(Direction.BACKWARD, 0, IntakeSide.FRONT), true));
		ButtonManager.addButton(new ActionButton(2, 11, new IntakeBall(IntakeSide.FRONT), true));
		ButtonManager.addButton(new ActionButton(2, 10, new GiveBallToShooter(IntakeSide.FRONT), true));
		ButtonManager.addButton(new ActionButton(2, 6, new DrivePosition(), false));
		ButtonManager.addButton(new ActionButton(2, 7, new Limbo(), false));
