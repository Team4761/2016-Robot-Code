...
public class ChevalDeFrise extends CommandGroup {
    ...
    public ChevalDeFrise(IntakeSide intakeSide) {
        ...
        addParallel(new AssistedDrive(AssistedTranslateType.ENCODER, AssistedRotateType.ENCODER, 24, 0, 12)); // Dummy inputs for distance and relativeAngle
        addSequential(new WaitCommand(1));
        addParallel(new SetVerticalIntake(20, intakeSide)); // Slowly lift arm as robot moves across
        addParallel(new AssistedDrive(AssistedTranslateType.ENCODER, AssistedRotateType.ENCODER, 12, 0, 12)); // Dummy inputs for distance and relativeAngle
    }
}
