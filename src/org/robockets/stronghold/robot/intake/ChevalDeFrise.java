...
public class ChevalDeFrise extends CommandGroup {
    ...
    public ChevalDeFrise(IntakeSide intakeSide) {
        ...
        addParallel(new AssistedDrive(AssistedTranslateType.ENCODER, AssistedRotateType.ENCODER, 25, 0, 0.7)); // Dummy inputs for distance and relativeAngle
        addSequential(new WaitCommand(1));
        addParallel(new SetVerticalIntake(20, intakeSide)); // Slowly lift arm as robot moves across
        addParallel(new AssistedDrive(AssistedTranslateType.ENCODER, AssistedRotateType.ENCODER, 15, 0, 0.5)); // Dummy inputs for distance and relativeAngle
    }
}
